...
public class IdentifiableUtil
{
	 ...
	 */
	static public <T extends Identifiable> T findIdentifiableFromId(Class<T> clazz, Long id, RdbLink em)
	{
		if (id==null)
		{
			return null;
	 ...
	 * 
	 */
	static public <T extends Identifiable> T pourInfofindIdentifiableFromIdOldStyle(Class<T> clazz, Long id, RdbLink em)
	{
