	...
	static public enum PERemiseProducteurAccess
	{
		...
		static public class MetaData extends MetaDataEnum
		{
			...
			{		
				...
				add(PRODUCTEUR, "Producteur,Referent,Trésorier,Admin" , "Dans ce mode, cet écran est accessible aux producteurs , référents, trésoriers et admin. C'est un cas assez rare, où le producteur gère lui même la remise des chèques. Un producteur peut accéder uniquement aux chèques qui le concernent directement.");
