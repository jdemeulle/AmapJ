...
/**
 * Parametrage de l'écran Producteur Referent
 */
public class PEProducteurReferent  extends AbstractParamEcran
{
	...
	// Acces à cet écran 
	public PEProducteurReferentAccess accesEcran = PEProducteurReferentAccess.ALL;
	
	
	static public enum PEProducteurReferentAccess
	{
		ALL , 
		...
		static public class MetaData extends MetaDataEnum
		{
			...
			public void fill()
			{		
				add("Ce champ vous permet de choisir les personnes pouvant accéder à l'écran Listes des producteurs et des référents");
	...
	{
		if (accesEcran==PEProducteurReferentAccess.ALL)
		{
			return true;
		}
		if (accesEcran==PEProducteurReferentAccess.NOBODY)
		{
			return false;
		}
	...
	public PEProducteurReferentAccess getAccesEcran() 
	{
		return accesEcran;
	}

	public void setAccesEcran(PEProducteurReferentAccess accesEcran) 
	{
