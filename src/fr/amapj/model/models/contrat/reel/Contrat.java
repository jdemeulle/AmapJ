...
public class Contrat  implements Identifiable
{
	...
	// Informations sur les contrats de type abonnement
	// Correspond à un objet de type AboData serialisé
	@Size(min = 0, max = 2048)
	@Column(length = 2048)
	public String aboInfo;
	
	// Le doc d'engagement signé
	// Peut être null 
	@ManyToOne
	public DocEngagementSigne docEngagementSigne;
