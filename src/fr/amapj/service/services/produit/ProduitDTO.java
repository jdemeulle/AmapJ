...
public class ProduitDTO implements TableItem
{
	...
	public ProduitLimiteQuantite getLimiteQuantite() {
		return limiteQuantite;
	}

	public void setLimiteQuantite(ProduitLimiteQuantite limiteQuantite) {
		this.limiteQuantite = limiteQuantite;
	}
	...
	public Long getIdProduitEnStock() {
		return idProduitEnStock;
	}

	public void setIdProduitEnStock(Long idProduitEnStock) {
		this.idProduitEnStock = idProduitEnStock;
	}
}
