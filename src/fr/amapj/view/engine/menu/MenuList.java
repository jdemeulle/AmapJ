...
{ 	
	...
	VISITE_AMAP("Découverte / Visite",FontAwesome.DELICIOUS),
	...
	TENANT_NOTIFICATION("Hébergement AmapJ",FontAwesome.ENVELOPE),
	...
	EXTENDED_PARAMETRES("Parametres généraux etendus",FontAwesome.HEART)
