...
/**
 * Permet de lister tous les utilisateurs, pour leur créer un nouveau contrat
 * 
 * La liste des utilisateurs proposée dépend du paramètre gestionAjoutContrat
 *
 */
public class SDUtilisateurAjoutContrat implements SearcherDefinition
{
	private GestionAjoutContrat gestionAjoutContrat;
	private Long idModeleContrat;


	public SDUtilisateurAjoutContrat(GestionAjoutContrat gestionAjoutContrat, Long idModeleContrat) 
	{
	...
	{
		return  new GestionContratSigneService().getUtilisateurSansContrat(idModeleContrat,gestionAjoutContrat);		
	}
