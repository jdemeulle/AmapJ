 ...
 *
 */
public class SDProduitOneProducteur implements SearcherDefinition
{
	private Long producteurId;

	public SDProduitOneProducteur(Long producteurId) 
	{
	...
	{
		return  new SearcherService().getAllProduits(producteurId);
	}
