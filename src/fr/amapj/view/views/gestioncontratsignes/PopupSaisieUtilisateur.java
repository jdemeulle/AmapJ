...
import fr.amapj.view.views.searcher.SDUtilisateurAjoutContrat;
...
public class PopupSaisieUtilisateur extends OKCancelPopup
{
	 ...
	 * 
	 */
	public PopupSaisieUtilisateur(AjouterData data, PEGestionContratsSignes peEcran)
	{
		this.data = data;
		this.peEcran = peEcran;
	...
	protected void createContent(VerticalLayout contentLayout)
	{
		...
		box = new Searcher(new SDUtilisateurAjoutContrat(peEcran.gestionAjoutContrat,data.idModeleContrat));
