 ...
 * 
 */
public class PEProducteurReferentEditorPart extends WizardFormPopup
{
	private PEProducteurReferent pe;

	/**
	 * 
	 */
	public PEProducteurReferentEditorPart()
	{
		pe = (PEProducteurReferent) new ParametresService().loadParamEcran(MenuList.LISTE_PRODUCTEUR_REFERENT);
	...
	{
		// Titre
		setStepTitle("Paramétrage des détails producteur");
		
		//
		addComboEnumField("Présentation des infos producteur ", "infoProducteurModeAffichage", new NotNullValidator());
