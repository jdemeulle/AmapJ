...
import fr.amapj.view.views.searcher.SDUtilisateurSansAdhesion;
...
public class PopupAjoutCotisation extends WizardFormPopup
{
	...
	private void addFieldInfoGenerales()
	{
		...
		// 
		addSearcher("Nom de l'adhérent", "idUtilisateur", new SDUtilisateurSansAdhesion(idPeriodeCotisation), null,notNull);
